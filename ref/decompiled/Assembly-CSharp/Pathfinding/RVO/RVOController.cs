...
public class RVOController : MonoBehaviour
{
	...
	public void Update()
	{
		...
		{
			base.transform.rotation = Quaternion.Lerp(base.transform.rotation, Quaternion.LookRotation(velocity), UpdateManager.deltaTime * rotationSpeed * Mathf.Min(velocity.magnitude, 0.2f));
		}
	}
