...
public abstract class NavGraph
{
	...
	public bool m_bIsVentLayer;

	public bool m_bIsUndergroundLayer;
	...
	{
		return GetNearest(position, AstarPath.m_NNnone);
	}
	...
	public virtual void Awake()
	{
		if (name != null)
		{
			m_bIsVentLayer = name.StartsWith("Vent");
			m_bIsUndergroundLayer = name.StartsWith("Underground");
		}
	}
	...
	public abstract void ScanInternal(OnScanStatus statusCallback, bool bUpdateNetworkService = false);
