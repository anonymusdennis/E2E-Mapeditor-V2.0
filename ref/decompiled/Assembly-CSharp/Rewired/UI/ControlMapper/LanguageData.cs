...
public class LanguageData : ScriptableObject
{
	...
	[UnityEngine.Tooltip("{0} = Joystick Name\n{1} = Other Player Name\n{2} = This Player Name")]
	[SerializeField]
	...
	[UnityEngine.Tooltip("{0} = Action Name")]
	[SerializeField]
	private string _joystickElementAssignmentPollingWindowMessage = "Now press a button or move an axis to assign it to {0}.";

	[UnityEngine.Tooltip("This text is only displayed when split-axis fields have been disabled and the user clicks on the full-axis field. Button/key/D-pad input cannot be assigned to a full-axis field.\n{0} = Action Name")]
	[SerializeField]
	...
	[UnityEngine.Tooltip("{0} = Element Name")]
	[SerializeField]
	...
	[UnityEngine.Tooltip("{0} = Other Player Name\n{1} = This Player Name")]
	[SerializeField]
	...
	[UnityEngine.Tooltip("{0} = Axis Name")]
	[SerializeField]
	...
	[UnityEngine.Tooltip("Message for a single player game.")]
	[SerializeField]
	...
	[UnityEngine.Tooltip("Message for a multi-player game.")]
	[SerializeField]
