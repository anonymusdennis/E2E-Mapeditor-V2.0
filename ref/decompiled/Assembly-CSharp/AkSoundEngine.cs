...
public class AkSoundEngine
{
	...
	public static uint AK_INVALID_AUX_ID => AkSoundEnginePINVOKE.CSharp_AK_INVALID_AUX_ID_get();

	public static uint AK_INVALID_CHANNELMASK => AkSoundEnginePINVOKE.CSharp_AK_INVALID_CHANNELMASK_get();

	public static uint AK_INVALID_OUTPUT_DEVICE_ID => AkSoundEnginePINVOKE.CSharp_AK_INVALID_OUTPUT_DEVICE_ID_get();

	public static uint AK_MIXER_FX_SLOT => AkSoundEnginePINVOKE.CSharp_AK_MIXER_FX_SLOT_get();
	...
	public static AKRESULT SetObjectPosition(GameObject in_gameObjectID, float PosX, float PosY, float PosZ, float FrontX, float FrontY, float FrontZ)
	{
	...
	public static AKRESULT RegisterGameObj(GameObject in_gameObjectID, string in_pszObjName)
	{
		...
		AKRESULT aKRESULT = RegisterGameObjInternal_WithName(in_gameObjectID.GetInstanceID(), in_pszObjName);
		if (aKRESULT == AKRESULT.AK_Success)
		{
			RegisteredGameObjects.Add(in_gameObjectID.GetInstanceID());
		}
	...
	public static AKRESULT RegisterGameObj(GameObject in_gameObjectID, string in_pszObjName, uint in_uListenerMask)
	{
		...
		AKRESULT aKRESULT = RegisterGameObjInternal_WithName_WithMask(in_gameObjectID.GetInstanceID(), in_pszObjName, in_uListenerMask);
		if (aKRESULT == AKRESULT.AK_Success)
		{
			RegisteredGameObjects.Add(in_gameObjectID.GetInstanceID());
		}
	...
	public static Playlist DynamicSequenceLockPlaylist(uint in_playingID)
	{
		...
		return (!(intPtr == IntPtr.Zero)) ? new Playlist(intPtr, cMemoryOwn: false) : null;
	}
	...
	{
		return new AkChannelConfig(AkSoundEnginePINVOKE.CSharp_GetSpeakerConfiguration__SWIG_0((int)in_eOutputType, in_iOutputID), cMemoryOwn: true);
	}

	public static AkChannelConfig GetSpeakerConfiguration(AkAudioOutputType in_eOutputType)
	{
		return new AkChannelConfig(AkSoundEnginePINVOKE.CSharp_GetSpeakerConfiguration__SWIG_1((int)in_eOutputType), cMemoryOwn: true);
	}

	public static AkChannelConfig GetSpeakerConfiguration()
	{
		return new AkChannelConfig(AkSoundEnginePINVOKE.CSharp_GetSpeakerConfiguration__SWIG_2(), cMemoryOwn: true);
	}

	public static AKRESULT GetPanningRule(out int out_ePanningRule, AkAudioOutputType in_eOutputType, uint in_iOutputID)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_GetPanningRule__SWIG_0(out out_ePanningRule, (int)in_eOutputType, in_iOutputID);
	}

	public static AKRESULT GetPanningRule(out int out_ePanningRule, AkAudioOutputType in_eOutputType)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_GetPanningRule__SWIG_1(out out_ePanningRule, (int)in_eOutputType);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetPanningRule__SWIG_0((int)in_ePanningRule, (int)in_eOutputType, in_iOutputID);
	}

	public static AKRESULT SetPanningRule(AkPanningRule in_ePanningRule, AkAudioOutputType in_eOutputType)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetPanningRule__SWIG_1((int)in_ePanningRule, (int)in_eOutputType);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_GetSpeakerAngles__SWIG_0(io_pfSpeakerAngles, ref io_uNumAngles, out out_fHeightAngle, (int)in_eOutputType, in_iOutputID);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_GetSpeakerAngles__SWIG_1(io_pfSpeakerAngles, ref io_uNumAngles, out out_fHeightAngle, (int)in_eOutputType);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetSpeakerAngles__SWIG_0(in_pfSpeakerAngles, in_uNumAngles, in_fHeightAngle, (int)in_eOutputType, in_iOutputID);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetSpeakerAngles__SWIG_1(in_pfSpeakerAngles, in_uNumAngles, in_fHeightAngle, (int)in_eOutputType);
	}
	...
	public static AKRESULT PostMIDIOnEvent(uint in_eventID, GameObject in_gameObjectID, AkMIDIPost in_pPosts, ushort in_uNumPosts)
	{
		AkAutoObject autoObject = null;
		uint jarg = (uint)AutoRegisterAkGameObj(in_gameObjectID, ref autoObject);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PostMIDIOnEvent(in_eventID, jarg, AkMIDIPost.getCPtr(in_pPosts), in_uNumPosts);
	}
	...
	public static AKRESULT StopMIDIOnEvent(uint in_eventID, GameObject in_gameObjectID)
	{
		AkAutoObject autoObject = null;
		uint jarg = (uint)AutoRegisterAkGameObj(in_gameObjectID, ref autoObject);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_StopMIDIOnEvent__SWIG_0(in_eventID, jarg);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SendPluginCustomGameData(in_busID, in_uFXIndex, in_pData, in_uSizeInBytes);
	}
	...
	public static AKRESULT SetMultiplePositions(GameObject in_GameObjectID, AkChannelEmitterArray in_pPositions, ushort in_NumPositions, MultiPositionType in_eMultiPositionType)
	{
		AkAutoObject autoObject = null;
		uint jarg = (uint)AutoRegisterAkGameObj(in_GameObjectID, ref autoObject);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetMultiplePositions__SWIG_2(jarg, in_pPositions.m_Buffer, in_NumPositions, (int)in_eMultiPositionType);
	}
	...
	public static AKRESULT SetMultiplePositions(GameObject in_GameObjectID, AkChannelEmitterArray in_pPositions, ushort in_NumPositions)
	{
		AkAutoObject autoObject = null;
		uint jarg = (uint)AutoRegisterAkGameObj(in_GameObjectID, ref autoObject);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetMultiplePositions__SWIG_3(jarg, in_pPositions.m_Buffer, in_NumPositions);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_AddSecondaryOutput__SWIG_0(in_iOutputID, (int)in_iDeviceType, in_uListenerMask, in_uOutputFlags, in_audioDeviceShareset);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_AddSecondaryOutput__SWIG_1(in_iOutputID, (int)in_iDeviceType, in_uListenerMask, in_uOutputFlags);
	}

	public static AKRESULT AddSecondaryOutput(uint in_iOutputID, AkAudioOutputType in_iDeviceType, uint in_uListenerMask)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_AddSecondaryOutput__SWIG_2(in_iOutputID, (int)in_iDeviceType, in_uListenerMask);
	}
	...
	public static AKRESULT PostCode(ErrorCode in_eError, ErrorLevel in_eErrorLevel, uint in_playingID, GameObject in_gameObjID, uint in_audioNodeID, bool in_bIsBus)
	{
		AkAutoObject autoObject = null;
		uint jarg = (uint)AutoRegisterAkGameObj(in_gameObjID, ref autoObject);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PostCode__SWIG_0((int)in_eError, (int)in_eErrorLevel, in_playingID, jarg, in_audioNodeID, in_bIsBus);
	}

	public static AKRESULT PostCode(ErrorCode in_eError, ErrorLevel in_eErrorLevel, uint in_playingID, GameObject in_gameObjID, uint in_audioNodeID)
	{
		AkAutoObject autoObject = null;
		uint jarg = (uint)AutoRegisterAkGameObj(in_gameObjID, ref autoObject);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PostCode__SWIG_1((int)in_eError, (int)in_eErrorLevel, in_playingID, jarg, in_audioNodeID);
	}

	public static AKRESULT PostCode(ErrorCode in_eError, ErrorLevel in_eErrorLevel, uint in_playingID, GameObject in_gameObjID)
	{
		AkAutoObject autoObject = null;
		uint jarg = (uint)AutoRegisterAkGameObj(in_gameObjID, ref autoObject);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PostCode__SWIG_2((int)in_eError, (int)in_eErrorLevel, in_playingID, jarg);
	}
	...
	public static AKRESULT PostString(string in_pszError, ErrorLevel in_eErrorLevel, uint in_playingID, GameObject in_gameObjID, uint in_audioNodeID, bool in_bIsBus)
	{
		AkAutoObject autoObject = null;
		uint jarg = (uint)AutoRegisterAkGameObj(in_gameObjID, ref autoObject);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PostString__SWIG_0(in_pszError, (int)in_eErrorLevel, in_playingID, jarg, in_audioNodeID, in_bIsBus);
	}

	public static AKRESULT PostString(string in_pszError, ErrorLevel in_eErrorLevel, uint in_playingID, GameObject in_gameObjID, uint in_audioNodeID)
	{
		AkAutoObject autoObject = null;
		uint jarg = (uint)AutoRegisterAkGameObj(in_gameObjID, ref autoObject);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PostString__SWIG_1(in_pszError, (int)in_eErrorLevel, in_playingID, jarg, in_audioNodeID);
	}

	public static AKRESULT PostString(string in_pszError, ErrorLevel in_eErrorLevel, uint in_playingID, GameObject in_gameObjID)
	{
		AkAutoObject autoObject = null;
		uint jarg = (uint)AutoRegisterAkGameObj(in_gameObjID, ref autoObject);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_PostString__SWIG_2(in_pszError, (int)in_eErrorLevel, in_playingID, jarg);
	}
	...
	public static AKRESULT GetPosition(GameObject in_GameObjectID, AkTransform out_rPosition)
	{
		AkAutoObject autoObject = null;
		uint jarg = (uint)AutoRegisterAkGameObj(in_GameObjectID, ref autoObject);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_GetPosition(jarg, AkTransform.getCPtr(out_rPosition));
	}
	...
	public static AKRESULT GetRTPCValue(uint in_rtpcID, GameObject in_gameObjectID, uint in_playingID, out float out_rValue, ref int io_rValueType)
	{
		AkAutoObject autoObject = null;
		uint jarg = (uint)AutoRegisterAkGameObj(in_gameObjectID, ref autoObject);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_GetRTPCValue__SWIG_0(in_rtpcID, jarg, in_playingID, out out_rValue, ref io_rValueType);
	}
	...
	public static AKRESULT GetRTPCValue(string in_pszRtpcName, GameObject in_gameObjectID, uint in_playingID, out float out_rValue, ref int io_rValueType)
	{
		AkAutoObject autoObject = null;
		uint jarg = (uint)AutoRegisterAkGameObj(in_gameObjectID, ref autoObject);
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_GetRTPCValue__SWIG_1(in_pszRtpcName, jarg, in_playingID, out out_rValue, ref io_rValueType);
	}
	...
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_AddPlayerMotionDevice__SWIG_0(in_iPlayerID, in_iCompanyID, in_iDeviceID, in_pDevice, in_uSize);
	}

	public static AKRESULT AddPlayerMotionDevice(byte in_iPlayerID, uint in_iCompanyID, uint in_iDeviceID, IntPtr in_pDevice)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_AddPlayerMotionDevice__SWIG_1(in_iPlayerID, in_iCompanyID, in_iDeviceID, in_pDevice);
	}

	public static AKRESULT AddPlayerMotionDevice(byte in_iPlayerID, uint in_iCompanyID, uint in_iDeviceID)
	{
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_AddPlayerMotionDevice__SWIG_2(in_iPlayerID, in_iCompanyID, in_iDeviceID);
	}
	...
	{
		return AkSoundEnginePINVOKE.CSharp_SetDecodedBankPath(in_DecodedPath);
	}
	...
	{
		int jarg = ((!(in_GameObjectID != null)) ? (-1) : in_GameObjectID.GetInstanceID());
		return (AKRESULT)AkSoundEnginePINVOKE.CSharp_SetObjectPosition(jarg, PosX, PosY, PosZ, FrontX, FrontY, FrontZ, TopX, TopY, TopZ);
	}
