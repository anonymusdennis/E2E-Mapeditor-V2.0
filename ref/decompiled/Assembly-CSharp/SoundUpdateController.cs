...
public class SoundUpdateController : IUpdateController
{
	...
	public void Register(IControlledUpdate behaviour)
	{
		if (behaviour != null)
		{
			AkGameObj akGameObj = behaviour as AkGameObj;
			if (!(akGameObj == null) && akGameObj.enabled && !m_UpdatableItems.Contains(behaviour))
			{
