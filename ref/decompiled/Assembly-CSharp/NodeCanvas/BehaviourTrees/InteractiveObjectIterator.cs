...
[Category("★T17")]
[Name("InteractiveObject Iterator")]
[Description("Iterate a list of InteractiveObjects and execute the child node for each element in the list. Keeps iterating until the Termination Condition is met or the whole list is iterated and return the child node status")]
[Icon("List", false)]
public class InteractiveObjectIterator : BTDecorator
{
	...
	[BlackboardOnly]
	[RequiredField]
	public BBParameter<List<InteractiveObject>> targetList;

	[BlackboardOnly]
	public BBParameter<InteractiveObject> current;
	...
	private List<InteractiveObject> list => (targetList == null) ? null : targetList.value;
